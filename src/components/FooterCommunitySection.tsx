        ...
        <div className="w-full flex flex-col items-center px-4 sm:px-6 md:px-8">
          ...
          <div className="flex flex-col items-center w-full max-w-xl relative z-10">
            ...
            <div className="flex flex-row gap-10 items-center justify-center mb-2">
              <a href="https://x.com/play_arenastudio?s=11" target="_blank" rel="noopener noreferrer" aria-label="X" className="hover:opacity-80 transition-opacity">
                <img src="/images/x.png" alt="X" className="w-14 h-14" />
              </a>
              <a href="https://www.instagram.com/play_arenastudio/?e=a3ef9de8-edc1-4c1b-ae84-39c7f477f4dc&g=5" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:opacity-80 transition-opacity"> 
